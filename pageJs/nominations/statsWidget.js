...
function loadStats(){
    ...
    if (!settings["darkMode"] && (document.documentElement.classList.contains("theme--dark") || document.documentElement.classList.contains("theme--auto") && window.matchMedia("(prefers-color-scheme: dark)").matches))
